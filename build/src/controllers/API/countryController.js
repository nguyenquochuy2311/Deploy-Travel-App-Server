    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            helper.checkPermission(req.user.role_id, 'country_add').then(function (rolePerm) {
              if (!req.body.country_name || !req.file || req.file === undefined) {
                ...
                Country.create({
                  ...
                  return res.status(201).send(countries);
...
var findOne = function findOne(req, res) {
  Country.findByPk(req.params.id).then(function (country) {
    if (!country) {
      res.status(404).send({
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            helper.checkPermission(req.user.role_id, 'country_update').then(function (rolePerm) {
              Country.findByPk(req.params.id).then(function (country) {
                if (country) {
                  Country.update({
...
var destroy = function destroy(req, res) {
  helper.checkPermission(req.user.role_id, 'country_delete').then(function (rolePerm) {
    if (!req.params.id) {
      res.status(400).send({
